...
function render() {
	rotLine1 = 0.04;
	groupBox.rotateOnAxis(new THREE.Vector3(1.0, 0.0, 0.0).normalize(), rotLine1);
	groupSphere.rotateOnAxis(new THREE.Vector3(0.0, 1.0, 0.0).normalize(), rotLine1);
	groupRing.rotateOnAxis(new THREE.Vector3(0.0, 0.0, 1.0).normalize(), rotLine1);
	rotLine2 = 0.04;
	groupSecondLine.rotateOnAxis(new THREE.Vector3(0.0, 1.0, 0.0).normalize(), rotLine2);
	rotLine3 = 0.02;
	groupThirdLine.rotateOnAxis(new THREE.Vector3(1.0, 0.0, 0.0).normalize(), rotLine3);
